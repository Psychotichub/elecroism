...
const WireToolOverlay: React.FC<Props> = ({
  ...
  const colors = getCanvasInteractionColors();
    ...
    <Group listening>
      ...
      {hoveredConnectionPoint && (
        <Circle
          ...
          radius={3}
          stroke={colors.wireHoverTerminal}
          strokeWidth={0.8}
          fill={colors.wireHoverTerminalFill}
          listening={false}
        />
      )}
      ...
      {wireDockHint &&
        (() => {
          const stroke = wireDockHint.aligned
            ? colors.wireDockAligned
            : colors.wireDockPending;
          const fill = wireDockHint.aligned
            ? colors.wireDockAlignedFill
            : colors.wireDockPendingFill;
          const half = 4;
          const tickLen = 3;
          const stemPoints =
            wireDockHint.axis === 'h'
