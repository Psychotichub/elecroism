...
const BacnetIpGatewaySymbol: React.FC<Props> = ({
  ...
  const terminalLabelColor = (label: string): string => {
    ...
    if (u.startsWith('MSTP_') || u.startsWith('RS485_')) return '#7C2D12';
    ...
    >
      <ScaledSymbolInner component={component}>
        ...
        <Rect
          ...
          shadowOffsetY={1}
        />
        <Text text="BACNET/IP" x={-28} y={-15} width={56} align="center" fontSize={9} fill="#4C1D95" fontStyle="bold" listening={false} />
        <Text text="MS/TP GATEWAY" x={-28} y={-4} width={56} align="center" fontSize={7} fill="#475569" listening={false} />
