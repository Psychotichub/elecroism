    ...
    >
      <ScaledSymbolInner component={component}>
        ...
        <Rect
          ...
          cornerRadius={4}
        />
        <Text text="MODBUS TCP" x={-28} y={-16} width={56} align="center" fontSize={8} fill="#1E3A8A" fontStyle="bold" listening={false} />
        ...
        <Line points={[-10, 14, 10, 14]} stroke="#6B7280" strokeWidth={1.2} />
