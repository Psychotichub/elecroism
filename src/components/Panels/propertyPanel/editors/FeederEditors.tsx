...
export const AddIdenticalFeederButton = () => {
  ...
  return (
    <div className="mt-2">
      <button
        type="button"
        className="w-full rounded bg-emerald-700 px-2 py-1.5 es-typo-body font-medium text-white hover:bg-emerald-600"
        onClick={() => duplicateIdenticalFeeder(selectedComp.id)}
      >
        Add identical feeder
      </button>
      <p className={`mt-1 es-typo-caption leading-snug ${tc.textMuted}`}>
